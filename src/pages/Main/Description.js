...
class Description extends Component {
  ...
  state = {
    features1: [
      { title: i18next.t('home.description.benefit1')},
      { title: i18next.t('home.description.benefit2')},
      { title: i18next.t('home.description.benefit3')},
      { title: i18next.t('home.description.benefit4')}
    ]
  };
          ...
          <Row className="align-items-center">
            <Col lg="6" md="7" className="mt-5 mt-sm-0">
              <div className="section-title">
                ...
                <p className="text-muted"> {i18next.t('home.description.description')} </p>
                <ul
